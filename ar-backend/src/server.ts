...
const uploadTestHtml = fileURLToPath(new URL("../public/upload-test.html", import.meta.url));
...
app.get("/upload-test", (_request, response) => response.sendFile(uploadTestHtml));
app.use(routes);
